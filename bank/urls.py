...
urlpatterns = [
    ...
    url(r'^ManagerHome/TransactionLookup$',views.TransactionLookup, name='TransactionLookup'),
    url(r'^ManagerHome/TAuthorize$',views.TAuthorize, name='TAuthorize'),
    ...
    url(r'^EmployeeHome/TransactionLookup$',views.TransactionLookup, name='TransactionLookup'),
    url(r'^EmployeeHome/TAuthorize$',views.TAuthorize, name='TAuthorize'),
